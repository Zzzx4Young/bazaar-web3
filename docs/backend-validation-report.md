...
日期：2026-09-11。范围：V1 依赖兼容性与最小运行骨架；以下保留 V1 当时的验收边界；随后完成的 V2 业务实验 schema、迁移与 DB-01—DB-11 见 [V2 报告](backend-v2-report.md)。对应[验证计划](backend-validation-plan.md)。
